...
# ── Sanity check ─────────────────────────────────────────────────────────────
def sanity_check():
    print("  Sanity check vs Module 1 (expected ~149, ~187, ~176 Mbps)...")
    expected = {50: 148.6, 125: 187.2, 200: 175.7}
    all_ok = True
...
=======
                if conv_ep is None and t > 183.0:
>>>>>>> 1df4c54 (Update sanity check expected values to match corrected OMA fix run)
                    conv_ep = ep
