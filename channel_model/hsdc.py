...
def plot_hsdc_clusters(positions, labels, centers, heads,
    ...
    plt.tight_layout()
    plt.savefig("results/hsdc/fig5_hsdc_clusters.png", dpi=150)
    plt.close()
...
def plot_dendrogram(Z, K_star):
    ...
    plt.tight_layout()
    plt.savefig("results/hsdc/fig6_dendrogram.png", dpi=150)
    plt.close()
...
def plot_comparison_bar(hsdc_metrics, baselines, K_star, sil_score):
    ...
    plt.tight_layout()
    plt.savefig("results/hsdc/fig7_comparison_bar.png", dpi=150)
    plt.close()
...
def plot_elbow_curve(positions):
    ...
    plt.suptitle("Optimal K Determination — Elbow + Silhouette Analysis",
                 fontsize=12, fontweight='bold')
    plt.tight_layout()
    plt.savefig("results/hsdc/fig8_inertia_elbow.png", dpi=150)
    plt.close()
